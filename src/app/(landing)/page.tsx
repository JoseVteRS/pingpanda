import { DiscordMessage } from "@/app/components/discord-message"
import { Heading } from "@/app/components/heading"
import { MaxWidthWrapper } from "@/app/components/max-width-wrapper"
import { MockDiscordUI } from "@/app/components/mock-discord-ui"
        ...
        <MaxWidthWrapper>
          <div className="relative mx-auto text-center flex flex-col items-center gap-10">
            ...
            <p className="text-base/7 text-gray-600 max-w-prose text-center text-pretty">
              PinPanda is the easiest way to monitor your SaaS. Get instant
              notifications for{" "}
