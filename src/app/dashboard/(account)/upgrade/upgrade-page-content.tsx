  ...
  return (
    <div className="max-w-3xl flex flex-col gap-8">
        ...
        <Card>
          ...
          <div>
            <p className="text-2xl font-bold">
              ...
              {usageData?.eventsLimit.toString() || 100}
            </p>
        ...
        <Card>
          ...
          <div>
            <p className="text-2xl font-bold">
              ...
              {usageData?.categoriesLimit.toString() || 10}
            </p>
      ...
      <div className="text-sm text-gray-500">
        ...
        {plan !== "PRO" ? (
          <p onClick={() => createCheckoutSession()} className="underline text-brand-600 cursor-pointer">
